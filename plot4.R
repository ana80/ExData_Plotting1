...
## PLOT 4 description:
## setting the plot parameter as 4 per page, repeating 2 former codes after little adjustmnts, adding 2 new plots 
...
png(file = "plot4.png", width=480, height=480)
	...
	par(mfcol= c(2,2))
		...
		with(HHdata2, plot(HHdata2$Date_Time, HHdata2$Sub_metering_1, type = "l", 
		...
		plot(HHdata2$Date_Time, HHdata2$Voltage, type = "l", 
			xlab = "datetime", ylab = "Voltage")
		
		plot(HHdata2$Date_Time, HHdata2$Global_reactive_power, type = "l", 
